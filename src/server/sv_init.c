...
void SV_Init( void ) {
	...
	sv_master[1] = Cvar_Get( "sv_master2", "wolfmaster.s4ndmod.com", CVAR_ARCHIVE );
	sv_master[2] = Cvar_Get( "sv_master3", "dpmaster.deathmask.net", CVAR_ARCHIVE );
	sv_master[3] = Cvar_Get( "sv_master4", "master.rtcwmp.com", CVAR_ARCHIVE );
