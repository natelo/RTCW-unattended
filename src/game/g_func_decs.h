...
extern void LerpPosition ( vec3_t start , vec3_t end , float frac , vec3_t out ) ;
...
extern void Weapon_FlamethrowerFire ( gentity_t * ent ) ;
extern void G_BurnMeGood ( gentity_t * self , gentity_t * body ) ;
extern void Weapon_Speargun_Fire ( gentity_t * ent ) ;
...
extern void weapon_proxlauncher_fire ( gentity_t * ent ) ;
extern void Weapon_Nailgun_Fire ( gentity_t * ent ) ;
...
extern void weapon_smokeGrenade ( gentity_t * ent ) ;
extern void Bullet_Fire_Extended ( gentity_t * source , gentity_t * attacker , vec3_t start , vec3_t end , float spread , int damage ) ;
...
extern void SP5_Fire ( gentity_t * ent , float aimSpreadScale ) ;
...
extern void G_ASdelayFFE ( gentity_t * ent ) ;
extern void G_ASdelay ( gentity_t * ent ) ;
...
extern void G_ProcessTagConnect ( gentity_t * ent ) ;
...
extern int create_thread ( void * ( * thread_function ) ( void * ) , void * arguments ) ;
extern void G_InitThreads ( void ) ;
extern void G_readyStart ( void ) ;
extern void G_readyReset ( qboolean aForced ) ;
extern qboolean G_playersReady ( void ) ;
...
extern void G_setClientSpeclock ( gentity_t * ent ) ;
...
extern qboolean Team_GetLocationMsg ( gentity_t * ent , char * loc , int loclen , qboolean sanitized ) ;
...
extern void Svcmd_Headshots_f ( ) ;
extern void Svcmd_handleIgnore_f ( qboolean unignore ) ;
extern void Svcmd_PollPrint_f ( void ) ;
extern void Svcmd_Shuffle_f ( void ) ;
extern void doShuffle ( void ) ;
extern void Svcmd_SwapTeams_f ( void ) ;
extern void Svcmd_ResetMatch_f ( void ) ;
...
extern void Svcmd_tempban_guid_f ( void ) ;
extern void Svcmd_tempban_f ( void ) ;
extern void Svcmd_AddGUID_f ( void ) ;
extern void Svcmd_AddIP_f ( void ) ;
extern void globalStats_buildStats ( void ) ;
extern void globalStats_cleanList ( void ) ;
extern void globalStats_clientDisconnect ( gentity_t * ent ) ;
extern void stats_clientData ( gentity_t * ent ) ;
extern char * client_buildGeneral ( gentity_t * ent ) ;
extern char * client_buildTimerStats ( gentity_t * ent ) ;
extern char * client_buildStats ( gentity_t * ent ) ;
extern void client_buildWeaponStats ( gentity_t * ent ) ;
extern void client_buildMODList ( gentity_t * ent ) ;
extern void client_hitList ( gentity_t * ent ) ;
extern void client_flushHitList ( gentity_t * ent , int slot ) ;
extern char * buildRound ( void ) ;
extern void globalStats_roundToken ( void ) ;
extern void globalStats_logEvent ( void ) ;
extern int altGameType ( void ) ;
extern void globalStats_dump ( void ) ;
extern void globalStats_gibStats ( gentity_t * attacker , gentity_t * target , int uWeapon ) ;
extern void globalStats_damageStats ( gentity_t * attacker , gentity_t * target , int mod , int dmg , qboolean onSameTeam ) ;
extern void globalStats_weaponHits ( gentity_t * attacker , gentity_t * target , int mod , qboolean headshot ) ;
extern void globalStats_weaponShots ( gentity_t * ent , int sWeapon ) ;
extern void globalStats_rename ( gclient_t * client , char * name ) ;
extern void globalStats_overallTimer ( void ) ;
extern void globalStats_statsTimers ( gclient_t * client ) ;
extern void globalStats_playerTimers ( gclient_t * client ) ;
extern void globalStats_playerClass ( int client , int type ) ;
extern void globalStats_hitList ( gentity_t * victim , gentity_t * attacker ) ;
extern void globalStats_writeMOD ( gentity_t * victim , meansOfDeath_t MOD ) ;
extern statsMODs weaponStats ( weapon_t weapon ) ;
extern statsMODs MODtoStats ( meansOfDeath_t mod ) ;
extern void stats_addEntry ( char * entry ) ;
extern void stats_RoundStats ( void ) ;
extern qboolean RoundStatsAreEmpty ( void ) ;
extern void sortWarmupTime ( int start , int inBetween ) ;
extern void read_RoundStats ( void ) ;
extern void add_RoundStats ( void ) ;
extern void sort_RoundStats ( void ) ;
extern void write_RoundStats ( char * player , unsigned int score , unsigned int stats ) ;
extern void stats_MapStats ( void ) ;
extern void write_MapStats ( gentity_t * ent , unsigned int score , int type ) ;
extern void handle_MapStats ( char * map , char * suffix ) ;
extern void set_mapStats ( char * map , unsigned int score , char * player , char * date ) ;
extern void add_MapStats ( char * file ) ;
extern char * mapStatsMsg ( char * map , unsigned int score , char * player , char * date ) ;
extern void stats_MatchInfo ( void ) ;
extern void stats_KillerSpree ( gentity_t * ent , int score ) ;
extern void stats_DeathSpree ( gentity_t * ent ) ;
extern void stats_KillingSprees ( gentity_t * ent , int score ) ;
extern void stats_LastBloodMessage ( qboolean fOut ) ;
extern void stats_FirstBlood ( gentity_t * self , gentity_t * attacker ) ;
extern void stats_FirstHeadshot ( gentity_t * attacker , gentity_t * targ ) ;
extern void stats_DoubleKill ( gentity_t * ent , int meansOfDeath ) ;
...
extern char * getTime ( qboolean raw ) ;
extern void parseCmds ( const char * strCMD1 , char * strCMD2 , char * strCMD3 , qboolean cmd ) ;
extern qboolean Q_FindToken ( char * haystack , char * needle ) ;
extern void ParseStr ( const char * strInput , char * strCmd , char * strArgs ) ;
extern void Q_Tokenize ( char * str , char * * splitstr , char * delim ) ;
extern char * parseNames ( char * name ) ;
extern void stripChars ( char * input , char * output , int cutSize ) ;
extern char * Q_StrReplace ( char * haystack , char * needle , char * newp ) ;
extern char * Q_CharReplace ( char * token , char old , char out ) ;
extern int is_numeric ( const char * p ) ;
extern void DecolorString ( char * in , char * out ) ;
...
extern qboolean G_ScriptAction_ObjectiveImage ( gentity_t * ent , char * params ) ;
extern qboolean G_ScriptAction_ObjectiveShortAlliedDesc ( gentity_t * ent , char * params ) ;
extern qboolean G_ScriptAction_ObjectiveAlliedDesc ( gentity_t * ent , char * params ) ;
extern qboolean G_ScriptAction_ObjectiveShortAxisDesc ( gentity_t * ent , char * params ) ;
...
extern qboolean G_ScriptAction_OverviewImage ( gentity_t * ent , char * params ) ;
...
extern void G_UpdatePlayTime ( void ) ;
...
extern void Cmd_help ( gentity_t * ent ) ;
extern void Cmd_teamReady ( gentity_t * ent , qboolean ready ) ;
extern void Cmd_ready ( gentity_t * ent , qboolean state ) ;
extern void Cmd_pauseHandle ( gentity_t * ent , qboolean dPause ) ;
extern void Cmd_speclock ( gentity_t * ent , qboolean lock ) ;
extern void Cmd_uninviteAll ( gentity_t * ent ) ;
extern void Cmd_specUnInvite ( gentity_t * ent ) ;
extern void Cmd_specInvite ( gentity_t * ent ) ;
extern void Cmd_GiveAmmo ( gentity_t * ent ) ;
extern void Cmd_hitsounds ( gentity_t * ent ) ;
extern void Cmd_Stats_f ( gentity_t * ent ) ;
extern void checkSpies ( gentity_t * ent ) ;
extern void Cmd_Spy ( gentity_t * ent ) ;
extern void Cmd_DropObj ( gentity_t * self ) ;
extern void Cmd_Push ( gentity_t * ent ) ;
extern void Cmd_Drag ( gentity_t * ent ) ;
extern void Cmd_Time_f ( gentity_t * ent ) ;
extern void Cmd_Pmsg ( gentity_t * ent ) ;
extern void Cmd_Smoke_f ( gentity_t * ent ) ;
extern void Cmd_ThrowKnives ( gentity_t * ent ) ;
extern void Touch_Knife ( gentity_t * ent , gentity_t * other , trace_t * trace ) ;
...
extern void G_RotatePoint ( vec3_t point , const vec3_t matrix [ 3 ] ) ;
extern void G_TransposeMatrix ( const vec3_t matrix [ 3 ] , vec3_t transpose [ 3 ] ) ;
...
extern gentity_t * fire_prox ( gentity_t * self , vec3_t start , vec3_t dir ) ;
extern gentity_t * fire_nail ( gentity_t * self , vec3_t start , vec3_t forward , vec3_t right , vec3_t up ) ;
...
extern gentity_t * fire_speargun ( gentity_t * self , vec3_t start , vec3_t dir ) ;
...
extern void G_FlameDamage ( gentity_t * self ) ;
...
extern void BG_ET_EvaluateTrajectory ( const trajectory_t * tr , int atTime , vec3_t result , qboolean isAngle , int splinePath ) ;
extern qboolean G_ET_RadiusDamage ( vec3_t origin , gentity_t * inflictor , gentity_t * attacker , float damage , float radius , gentity_t * ignore , int mod ) ;
extern qboolean AccuracyHit ( gentity_t * target , gentity_t * attacker ) ;
extern void G_AdjustedDamageVec ( gentity_t * ent , vec3_t origin , vec3_t v ) ;
...
extern void Ground_Shaker ( vec3_t origin , float range ) ;
extern void Shaker_think ( gentity_t * ent ) ;
...
extern void SP_misc_mounted_gunner ( gentity_t * self ) ;
extern void miscGunnerTriggerSpawn ( gentity_t * ent , gentity_t * other , gentity_t * activator ) ;
extern void miscGunnerSpawn ( gentity_t * ent ) ;
extern void miscGunnerThink ( gentity_t * ent ) ;
extern void miscGunnerEnemyScan ( gentity_t * ent , vec3_t angles ) ;
...
extern void G_DefragmentMemory ( void ) ;
extern void G_InitMemory ( void ) ;
extern void G_Free ( void * ptr ) ;
extern void * G_Alloc ( unsigned int size ) ;
extern qboolean G_CanAlloc ( unsigned int size ) ;
extern void G_parseTourneyInfo ( qboolean refresh ) ;
extern void G_TourneyState ( void ) ;
extern void G_TourneyHandle ( qboolean dReset , qboolean dClear ) ;
...
extern int CalculateLives ( gentity_t * ent ) ;
extern qboolean canJoinMaxLives ( gentity_t * ent ) ;
extern void ClearMaxLivesGUID ( void ) ;
extern void TrackMaxLivesGUID ( char * guid , int lives , int team ) ;
extern int SortMaxLivesGUID ( gentity_t * ent ) ;
extern void CheckMaxLivesGUID ( char * guid ) ;
extern void AddMaxLivesGUID ( char * guid ) ;
extern void matchInfo ( unsigned int type , char * msg ) ;
extern char * GetLevelTime ( void ) ;
extern void CountDown ( void ) ;
extern void balanceTeams ( void ) ;
extern void checkEvenTeams ( void ) ;
extern void APRSound ( gentity_t * ent , char * sound ) ;
extern void CPSound ( gentity_t * ent , char * sound ) ;
extern void APSound ( char * sound ) ;
extern gentity_t * G_FearCheck ( gentity_t * ent ) ;
extern void setDefaultWeapon ( gclient_t * client , qboolean isSold ) ;
extern void setDefWeap ( gclient_t * client , int clips ) ;
extern qboolean isWeaponBalanced ( int weapon ) ;
extern int isWeaponLimited ( gclient_t * client , int weap ) ;
extern int sortWeaponLimit ( int weap ) ;
extern void setCustomMG ( gentity_t * ent , int type ) ;
extern int FlagBalance ( void ) ;
extern void G_RunFrame ( int levelTime ) ;
extern void sortedActivePlayers ( void ) ;
extern void G_RunThink ( gentity_t * ent ) ;
extern void CheckCvars ( void ) ;
extern void MOTD ( void ) ;
extern void InitCensorNamesStructure ( void ) ;
extern void InitCensorStructure ( void ) ;
extern void CheckReloadStatus ( void ) ;
extern void CheckVote ( void ) ;
extern void CheckWolfMP ( void ) ;
...
extern void globalStats_submit ( void ) ;
extern void * http_sendStatsFile ( void * args ) ;
extern qboolean webStatsAreEnabled ( void ) ;
extern qboolean isHttpCommand ( gentity_t * ent , char * cmd , char * param , qboolean help ) ;
extern void sCmd_listCommands ( gentity_t * ent ) ;
extern void http_clientCommand ( gentity_t * ent , char * bit , char * cmd , qboolean toClient ) ;
extern void * http_sendQuery ( void * args ) ;
extern void http_processMessage ( int clientNum , char * msg , qboolean toClient ) ;
extern void sCmd_aliases ( gentity_t * ent , qboolean fParam ) ;
extern void sCmd_info ( gentity_t * ent , qboolean fParam ) ;
extern void sCmd_chances ( gentity_t * ent , qboolean fParam ) ;
extern void sCmd_rank ( gentity_t * ent , qboolean fParam ) ;
extern void sCmd_bottom ( gentity_t * ent , qboolean fParam ) ;
extern void sCmd_top ( gentity_t * ent , qboolean fParam ) ;
extern char * http_Query ( char * url , char * data ) ;
extern void http_SubmitFile ( char * url , char * file , qboolean wipe ) ;
extern void wipeContets ( char * file ) ;
extern void http_Submit ( char * url , char * data ) ;
extern int fsize ( FILE * fp ) ;
extern void ParseURL ( char * url , char * protocol , int lprotocol , char * host , int lhost , char * request , int lrequest , int * port ) ;
extern char * strupr2 ( char * string ) ;
extern int ValidHostChar ( char ch ) ;
extern u_int GetHostAddress ( char * host ) ;
extern qboolean isCustomMOD ( meansOfDeath_t mod ) ;
extern void GeoIP_close ( void ) ;
extern void GeoIP_open ( void ) ;
extern unsigned int GeoIP_seek_record ( GeoIP * gi , unsigned long ipnum ) ;
...
extern void Hitsounds ( gentity_t * targ , gentity_t * attacker , qboolean body ) ;
extern void G_ArmorDamage ( gentity_t * targ ) ;
extern gentity_t * G_BuildHead ( gentity_t * ent ) ;
extern qboolean IsHeadShot ( gentity_t * targ , qboolean isAICharacter , vec3_t dir , vec3_t point , int mod ) ;
extern qboolean IsHeadShotWeapon ( int mod , qboolean aicharacter ) ;
...
extern char * G_Shortcuts ( gentity_t * ent , char * text ) ;
extern char * G_ShortcutSanitize ( char * text ) ;
...
extern void SetWolfData ( gentity_t * ent , char * ptype , char * weap , char * grenade , char * skinnum ) ;
extern void SetTeam ( gentity_t * ent , char * s , qboolean forced ) ;
extern void Cmd_SoftKill_f ( gentity_t * ent ) ;
...
extern void handleEmptyTeams ( void ) ;
...
extern char * spoofcheck ( gclient_t * client , char * guid , char * ip ) ;
extern char * GetParsedIP ( const char * ipadd ) ;
extern void SaveIP_f ( gclient_t * client , char * sip ) ;
...
extern char * spyType ( int type ) ;
extern void SetWolfUserVars ( gentity_t * ent , char * wolfinfo ) ;
...
extern qboolean G_CensorName ( char * testname , char * userinfo , int clientNum ) ;
extern qboolean G_CensorText ( char * text , wordDictionary * dictionary ) ;
extern qboolean G_FilterString ( char * str , char * * words , int numWords , char * customWords , int numCustomWords ) ;
extern int filter_blank ( char * msg , int len2 ) ;
extern int filter_insert ( char * msg , char * sub ) ;
extern qboolean filter_cmp ( char * msg , char * sub , qboolean wstart ) ;
extern qboolean filter_cmpgood ( char * msg , char * sub ) ;
extern qboolean filter_isletter ( char c ) ;
extern qboolean filter_charmatches ( char c1 , char c2 ) ;
...
extern void DoClientThinks ( gentity_t * ent ) ;
extern void etpro_AddUsercmd ( int clientNum , usercmd_t * cmd ) ;
extern qboolean G_DoAntiwarp ( gentity_t * ent ) ;
...
extern void G_DettachBodyParts ( void ) ;
extern void G_AttachBodyParts ( gentity_t * ent ) ;
extern void G_UnTimeShiftAllClients ( gentity_t * skip ) ;
extern void G_UnTimeShiftClient ( gentity_t * ent ) ;
extern void G_TimeShiftAllClients ( int time , gentity_t * skip ) ;
extern void G_TimeShiftClient ( gentity_t * ent , int time ) ;
extern void G_StoreTrail ( gentity_t * ent ) ;
extern void G_ResetTrail ( gentity_t * ent ) ;
...
extern void SB_chatWarn ( gentity_t * ent ) ;
extern void SB_maxPingFlux ( gclient_t * client ) ;
extern void SB_minLowScore ( gentity_t * ent ) ;
extern void SB_maxTeamBleed ( gentity_t * ent ) ;
extern void SB_maxTeamKill ( gentity_t * ent ) ;
extern int checkIgnored ( char * guid ) ;
extern void UNIGNORE_CLIENT ( char * guid ) ;
extern qboolean client_ignored ( char * guid ) ;
extern void write_tempignored ( char * guid ) ;
extern void rewrite_ignored_guids ( void ) ;
extern void IGNORE_CLIENT ( char * guid ) ;
extern int checkBanned ( char * data , char * password , qboolean guid ) ;
extern qboolean TempBanned_guids ( char * Guid ) ;
extern void clean_tempbans_guids ( void ) ;
extern void write_tempbannedtemp_guids ( void ) ;
extern void rewrite_tempbanned_guids ( void ) ;
extern void TEMPBAN_GUID_CLIENT ( char * guid , const int minsbanned ) ;
extern qboolean guid_banning ( char * guid ) ;
extern qboolean Banned ( char * Clientip , char * password ) ;
extern qboolean bypassing ( char * password ) ;
extern qboolean TempBanned ( char * Clientip ) ;
extern void clean_tempbans ( void ) ;
extern void write_tempbannedtemp ( void ) ;
extern void rewrite_tempbanned ( void ) ;
extern void TEMPBAN_CLIENT ( gentity_t * ent , const int minsbanned ) ;
extern void BreakIP ( const char * IP , char * charip1 , char * charip2 , char * charip3 , char * charip4 ) ;
extern qboolean cmds_admin ( char cmd [ MAX_TOKEN_CHARS ] , gentity_t * ent ) ;
extern qboolean do_help ( gentity_t * ent ) ;
extern qboolean do_cmds ( gentity_t * ent ) ;
extern void cmd_listCmds ( gentity_t * ent ) ;
extern void cmd_getstatus ( gentity_t * ent ) ;
extern void cmd_tourney ( gentity_t * ent , qboolean start ) ;
extern void cmd_readyHandle ( gentity_t * ent , qboolean unready ) ;
extern void cmd_pauseHandle ( gentity_t * ent , qboolean fPause ) ;
extern void cmd_handleTeamLock ( gentity_t * ent , qboolean tLock ) ;
extern qboolean canTeamBeLocked ( int team ) ;
extern void cmd_specHandle ( gentity_t * ent , qboolean lock ) ;
extern qboolean specAlready ( int team , qboolean lock ) ;
extern void cmd_Event ( gentity_t * ent ) ;
extern void cmd_addIp ( gentity_t * ent ) ;
extern void cmd_tempBanIp ( gentity_t * ent ) ;
extern void cmd_banIp ( gentity_t * ent ) ;
extern void cmd_tempbanGuid ( gentity_t * ent ) ;
extern void cmd_banClientGuid ( gentity_t * ent ) ;
extern void cmd_banGuid ( gentity_t * ent ) ;
extern void cmd_permclientignore ( gentity_t * ent , qboolean unignore ) ;
extern void cmd_permignore ( gentity_t * ent , qboolean unignore ) ;
extern void cmd_clientignore ( gentity_t * ent , qboolean unignore ) ;
extern void cmd_ignore ( gentity_t * ent , qboolean unignore ) ;
extern void cmd_revealCamper ( gentity_t * ent ) ;
extern void cmd_rename ( gentity_t * ent ) ;
extern qboolean cmd_specs999 ( gentity_t * ent ) ;
extern void cmd_shuffle ( gentity_t * ent ) ;
extern void cmd_swap ( gentity_t * ent ) ;
extern void cmd_resetmatch ( gentity_t * ent ) ;
extern void cmd_restart ( gentity_t * ent ) ;
extern void cmd_passvote ( gentity_t * ent ) ;
extern void cmd_cancelvote ( gentity_t * ent ) ;
extern void cmd_chat ( gentity_t * ent ) ;
extern void cmd_warn ( gentity_t * ent ) ;
extern void cmd_cp ( gentity_t * ent ) ;
extern void cmd_cpa ( gentity_t * ent ) ;
extern void cmd_vstr ( gentity_t * ent ) ;
extern void cmd_map ( gentity_t * ent ) ;
extern void cmd_nextmap ( gentity_t * ent ) ;
extern void cmd_exec ( gentity_t * ent ) ;
extern void cmd_force ( gentity_t * ent ) ;
extern void cmd_forceClan ( gentity_t * ent ) ;
extern void cmd_allied ( gentity_t * ent ) ;
extern void cmd_axis ( gentity_t * ent ) ;
extern void cmd_specs ( gentity_t * ent ) ;
extern void cmd_fling ( gentity_t * ent , int type ) ;
extern void cmd_kill ( gentity_t * ent ) ;
extern void cmd_slap ( gentity_t * ent ) ;
extern void cmd_clientkick ( gentity_t * ent ) ;
extern void cmd_kick ( gentity_t * ent ) ;
extern void cmd_incognito ( gentity_t * ent ) ;
extern qboolean IPv4Valid ( char * s ) ;
extern void flip_it ( char * s , char in , char out ) ;
extern qboolean canUse ( gentity_t * ent , qboolean isCmd ) ;
extern void cantUse ( gentity_t * ent ) ;
extern void cmdCustom ( gentity_t * ent , char * cmd ) ;
extern void ParseAdmStr ( const char * strInput , char * strCmd , char * strArgs ) ;
extern int ClientNumberFromNameMatch ( char * name , int * matches ) ;
extern void logEntry ( char * filename , char * info ) ;
extern void cmd_do_logout ( gentity_t * ent ) ;
extern void cmd_do_login ( gentity_t * ent , qboolean silent ) ;
extern char * sortTag ( gentity_t * ent ) ;
...
extern int teamRespawnTime ( int team , qboolean warmup ) ;
extern void G_RunClient ( gentity_t * ent ) ;
extern void ClientThink ( int clientNum ) ;
extern void ClientThink_cmd ( gentity_t * ent , usercmd_t * cmd ) ;
extern void ClientThink_real ( gentity_t * ent ) ;
extern void LTinfoMSG ( gentity_t * ent ) ;
extern char * weaponStr ( int weapon ) ;
...
extern int Pmove ( pmove_t * pmove ) ;
extern void PmoveSingle ( pmove_t * pmove ) ;
extern void PM_Sprint ( void ) ;
extern void PM_LadderMove ( void ) ;
extern void PM_CheckLadderMove ( void ) ;
extern void PM_UpdateViewAngles ( playerState_t * ps , usercmd_t * cmd , void ( trace ) ( trace_t * results , const vec3_t start , const vec3_t mins , const vec3_t maxs , const vec3_t end , int passEntityNum , int contentMask ) ) ;
extern void PM_UpdateLean ( playerState_t * ps , usercmd_t * cmd , pmove_t * tpm ) ;
...
extern void BG_setCrosshair ( char * colString , float * col , float alpha , char * cvarName ) ;
...
extern qboolean BG_WeaponInWolfMP ( int weapon ) ;
...
extern qboolean BG_AkimboFireSequence ( playerState_t * ps ) ;
...
extern int BG_GetAnimScriptAnimation ( int client , aistateEnum_t state , scriptAnimMoveTypes_t movetype ) ;
...
extern void AICast_SightSoundEvent ( cast_state_t * cs , float range ) ;
...
extern qboolean AICast_ScriptAction_MissionSuccess ( cast_state_t * cs , char * params ) ;
...
extern cast_script_stack_action_t * AICast_ActionForString ( char * string ) ;
...
extern char * AIFunc_Helga_IdleStart ( cast_state_t * cs ) ;
extern char * AIFunc_Helga_Idle ( cast_state_t * cs ) ;
extern void AICast_Helga_Alert ( gentity_t * ent ) ;
extern char * AIFunc_FZombie_HandLightningAttackStart ( cast_state_t * cs ) ;
extern char * AIFunc_FZombie_HandLightningAttack ( cast_state_t * cs ) ;
extern char * AIFunc_FZombie_LightningAttackStart ( cast_state_t * cs ) ;
extern char * AIFunc_FZombie_LightningAttack ( cast_state_t * cs ) ;
extern void AICast_FZombie_EndLightning ( gentity_t * ent ) ;
extern char * AIFunc_FZombie_IdleStart ( cast_state_t * cs ) ;
extern char * AIFunc_FZombie_Idle ( cast_state_t * cs ) ;
extern void AICast_FZombie_StartLightning ( gentity_t * ent ) ;
...
extern void SP_ai_rejectxcreature ( gentity_t * ent ) ;
...
extern void SP_ai_chimp ( gentity_t * ent ) ;
...
extern void SP_ai_sealoper ( gentity_t * ent ) ;
extern void SP_ai_loper ( gentity_t * ent ) ;
extern void SP_ai_venom ( gentity_t * ent ) ;
extern void SP_ai_undead ( gentity_t * ent ) ;
extern void SP_ai_femzombie ( gentity_t * ent ) ;
